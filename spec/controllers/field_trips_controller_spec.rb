...
describe FieldTripsController do
  ...
  describe "GET index" do
    it "assigns all field_trips as @field_trips" do
      ...
      assigns(:field_trips).should eq([field_trip])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested field_trip as @field_trip" do
      ...
      assigns(:field_trip).should eq(field_trip)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new field_trip as @field_trip" do
      ...
      assigns(:field_trip).should be_a_new(FieldTrip)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created field_trip as @field_trip" do
        post :create, {:field_trip => valid_attributes}, valid_session
        assigns(:field_trip).should be_a(FieldTrip)
        assigns(:field_trip).should be_persisted
      end

      it "redirects to the created field_trip" do
        post :create, {:field_trip => valid_attributes}, valid_session
        response.should redirect_to(FieldTrip.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved field_trip as @field_trip" do
        ...
        FieldTrip.any_instance.stub(:save).and_return(false)
        post :create, {:field_trip => {}}, valid_session
        assigns(:field_trip).should be_a_new(FieldTrip)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested field_trip" do
        field_trip = FieldTrip.create! valid_attributes
        # Assuming there are no other field_trips in the database, this
        # specifies that the FieldTrip created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        FieldTrip.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => field_trip.to_param, :field_trip => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the field_trip" do
        field_trip = FieldTrip.create! valid_attributes
        put :update, {:id => field_trip.to_param, :field_trip => valid_attributes}, valid_session
        response.should redirect_to(field_trip)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the field_trip as @field_trip" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        FieldTrip.any_instance.stub(:save).and_return(false)
        put :update, {:id => field_trip.to_param, :field_trip => {}}, valid_session
        assigns(:field_trip).should eq(field_trip)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the field_trips list" do
      field_trip = FieldTrip.create! valid_attributes
      delete :destroy, {:id => field_trip.to_param}, valid_session
      response.should redirect_to(field_trips_url)
    end
  end
